...
let view_projection_mat = world_to_camera.mult(projection_matrix);
...
function frame() {
    ...
    if (mesh != null) {
        ...
        for (let i = 0; i < mesh.triangles.length; i += 3) {
            ...
            let r0 = vertex_to_raster_space(a, camera, world_to_camera, projection_matrix);
            let r1 = vertex_to_raster_space(b, camera, world_to_camera, projection_matrix);
            let r2 = vertex_to_raster_space(c, camera, world_to_camera, projection_matrix);
